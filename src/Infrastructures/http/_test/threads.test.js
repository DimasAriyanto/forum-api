...
describe('/threads endpoint', () => {
  ...
  it('should response 400 if payload is incomplete', async () => {
    ...
    expect(responseJson.message).toEqual('harus mengirimkan input');
  });
  ...
  it('should response 400 if payload data type is invalid', async () => {
    ...
    expect(responseJson.status).toEqual('fail');
    expect(responseJson.message).toBeDefined();
    expect(responseJson.message).toEqual('input harus string');
  });
  ...
  it('should response code 200 when getting thread', async () => {
    ...
    expect(responseJson.data.thread.body).toEqual('isi sebuah thread');
